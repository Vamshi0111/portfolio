  ...
  return (
    <div style={{ backgroundColor: '#0E1123' }} className={`flex h-auto w-full flex-col `}>
          ...
          <div id='projects-section' className={`bg-violet-00 flex flex-col sm:mt-5 mt-2 lg:w-full lg:pl-22 lg:mt-10 overflow-hidden`}>
            ...
            <div className='flex flex-col items-start overflow-y-auto lg:overflow-hidden sm:flex p-3 sm:px-4 sm:px-2 lg:flex lg:flex-row lg:items-center w-[100%] h-[300px] lg:w-[93%] lg:gap-10 mt-5 sm:mt-5 lg:mt-10 bg-rose-00 lg:mr-44 lg:h-[200px] rounded-[20px] sm:rounded-[20px] lg:rounded-[20px] lg:p-3 lg:pl-5 bg-[#16193A] border border-[#5E77B1] transition-transform hover:-translate-y-2 duration-200'>
              ...
              <div className={`bg-green-00 lg:h-[80%] lg:w-[65%]`}>
                <div className='flex items-center justify-between'>
                  ...
                  >
                    <div className='w-[55px] sm:w-[65px] sm:h-[33px] mt-7 pl-1 lg:mt-0 sm:mt-0 lg:w-[85px] lg:h-[35px] border rounded-full flex items-center justify-between sm:pl-2 sm:pr-1 lg:pl-3 lg:pr-3 hover:bg-red-400 hover:-translate-y-1 transition-transform duration-200'>
                      <p>Visit</p>
                      <FaCaretRight />
                    </div>
                  </a>
                </div>
                <p className='mt-2 lg:mt-3'>We are a passionate team of tech experts focused on turning your ideas into reality.
              ...
              <div className={`bg-green-00 lg:h-[80%] lg:w-[65%]`}>
                <div className='flex mt-2 sm:mt-5 lg:mt-0 items-center justify-between'>
                  ...
                  <a href="https://devrootz.com/"
                    ...
                    rel="noopener noreferrer"
                  >
                    <div className='w-[55px] sm:w-[65px] sm:h-[33px] pl-1 lg:mt-0 sm:mt-0 lg:w-[85px] lg:h-[35px] border rounded-full flex items-center justify-between sm:pl-2 sm:pr-1 lg:pl-3 lg:pr-3 hover:bg-red-400 hover:-translate-y-1 transition-transform duration-200'>
                      <p>Visit</p>
                      <FaCaretRight />
                    </div>
                  </a>
                </div>
                <p className='mt-2 lg:mt-3'>Devrootz Hub equips you with cutting-edge tech skills and bridges the gap between learning and employment. Our expert-led training programs focus on the most in-demand technologies, ensuring you&apos;re job-ready. With hands-on learning and personalized placement support, we empower you to succeed in the competitive tech industry and land your dream role confidently.
                </p>
              </div>
            </div>
            {/* Devrootz card */}
            ...
            <div className='flex flex-col items-start overflow-y-auto lg:overflow-hidden sm:flex p-3 sm:px-4 lg:flex lg:flex-row lg:items-center w-[100%] h-[300px] lg:w-[93%] lg:gap-10 mt-5 sm:mt-5 lg:mt-10 bg-rose-00 lg:mr-44 lg:h-[200px] rounded-[20px] sm:rounded-[20px] lg:rounded-[20px] pt-3 lg:p-3 lg:pl-5 bg-[#16193A] border border-[#5E77B1] transition-transform hover:-translate-y-2 duration-200'>
              ...
              <div className={`bg-green-00 lg:h-[80%] lg:w-[65%]`}>
                ...
                <p className='mt-2 lg:mt-3'>We are a team of dedicated IT consultants committed to helping businesses grow in the digital era.
            ...
            <div className='flex flex-col items-start overflow-y-auto lg:overflow-hidden sm:flex p-3 sm:px-4 lg:flex lg:flex-row lg:items-center w-[100%] h-[300px] lg:w-[93%] lg:gap-10 mt-5 sm:mt-5 lg:mt-10 bg-rose-00 lg:mr-44 lg:h-[200px] rounded-[20px] sm:rounded-[20px] lg:rounded-[20px] pt-3 lg:p-3 lg:pl-5 bg-[#16193A] border border-[#5E77B1] transition-transform hover:-translate-y-2 duration-200'>
              ...
              <div className={`bg-green-00 lg:h-[80%] lg:w-[65%]`}>
                ...
                <p className='mt-2 sm:mt-3 lg:mt-3'>MessengerApp is a real-time cross-platform messaging application developed using React for web and React Native for mobile.
            ...
            <div className='flex flex-col items-start overflow-y-auto lg:overflow-hidden sm:flex p-3 sm:px-4 lg:flex lg:flex-row lg:items-center w-[100%] h-[300px] lg:w-[93%] lg:gap-10 mt-5 sm:mt-5 lg:mt-10 bg-rose-00 lg:mr-44 lg:h-[200px] rounded-[20px] sm:rounded-[20px] lg:rounded-[20px] pt-3 lg:p-3 lg:pl-5 bg-[#16193A] border border-[#5E77B1] transition-transform hover:-translate-y-2 duration-200'>
              ...
              <div className={`bg-green-00 lg:h-[80%] lg:w-[65%]`}>
                ...
                <p className='mt-2 sm:mt-3 lg:mt-3'>ShipEase is a transport logistics app built with React (web) and React Native (mobile).
                    ...
                    <form onSubmit={sendEmail} className='lg:mt-3 flex flex-col lg:w-[100%]'>
                      <div className='lg:w-full flex mt-3 sm:mt-4 lg:mt-0 justify-between lg:h-[50px]'>
                        <input
                          ...
                          className='shadow-lg p-2 rounded-lg w-[45%] sm:w-[40%] lg:w-[45%] bg-[#232959]'
                        />
                        <input
                          type="text"
                          name='email'
                      ...
                      <input
                        ...
                        value={form.subject}
                        onChange={handleChange}
                        className='shadow-lg p-2 rounded-lg bg-[#232959] mt-3 sm:mt-4 lg:mt-5 lg:h-[50px]'
                      />
                      <textarea
                        rows={5}
                        name='message'
      ...
      <div className='sm:h-[40px] lg:h-[60px] bg-[#1C2148] mt-8 sm:mt-15 lg:mt-15 flex items-center justify-center'>
        ...
        <LiaCopyrightSolid />
        <p className='ml-1 sm:ml-1 lg:ml-1 text-xs sm:text-sm lg:text-lg'>2025 Vamshi. All rights reserved.</p>
      </div>
      {/* Footer */}
    </div>
  )
